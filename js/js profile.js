...
async function initializePage() {
    ...
    if (registration_Number) {
        console.log("Registration number found in session storage. Fetching credentials...");
        await fetchClientCredentials(); // Await fetch and display existing credentials
    } else {
        console.log("No registration number found. Proceeding without fetching credentials.");
    }
}
...
function saveClientCredentials() {
    ...
    console.log("Captured values:", registration_Number, clientid, client_secret, userId);
...
async function fetchClientCredentials() {
    ...
    try {
        console.log("Attempting to fetch credentials with payload:", payload);
        ...
        if (response.ok) {
            ...
            if (data && data.credentials && Array.isArray(data.credentials)) {
                ...
                console.log("No existing credentials found in API response.");
            }
        } else {

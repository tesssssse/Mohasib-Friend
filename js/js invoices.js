...
function displayAlarms(alarms) {
    ...
    if (alarms && Array.isArray(alarms) && alarms.length > 0) {
        ...
        alarms.forEach((alarmData, alarmIndex) => {
            console.log(`Processing alarm ${alarmIndex + 1}`);
            ...
            alarmRows.forEach((row, rowIndex) => {
                ...
                // الكشف عن بداية إدخال تنبيه جديد
                    ...
                    if (alarmType && date && documentNumber) {
                        ...
                        console.log(`Collected entry - Alarm Type: ${alarmType}, Date: ${date}, Document Number: ${documentNumber}`);
                    }
                ...
                if (alarmType && date && documentNumber) {
                    ...
                    console.log(`Collected complete entry - Alarm Type: ${alarmType}, Date: ${date}, Document Number: ${documentNumber}`);
            ...
            if (alarmType && date && documentNumber) {
                ...
                console.log(`Collected final entry - Alarm Type: ${alarmType}, Date: ${date}, Document Number: ${documentNumber}`);
            }
        });
        ...
        console.log('Sorted Alarm Entries:', alarmEntries);
        ...
        alarmEntries.forEach(entry => {
            ...
            `);
            console.log(`Appended row - Alarm Type: ${entry.alarmType}, Date: ${entry.date}, Document Number: ${entry.documentNumber}`);
        });
    } else {
        tableBody.append(`<tr><td colspan="3">لا يوجد أخطاء في الفواتير</td></tr>`);
        console.log("No alarms data to display.");
    }

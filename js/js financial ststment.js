...
function displayFile(file) {
    console.log("Displaying file:", file); // Log the file object
...
async function fetchFile() {
    ...
    console.log("Fetching file for registration number:", registrationNumber);
    ...
    try {
        ...
        if (response.ok) {
            console.log("File fetched successfully from API.");
            const data = await response.json();

            console.log("Data available, calling displayFile...");
            ...
            console.log("Displaying file:", parsedBody);

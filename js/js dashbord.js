 ...
 */
 function setSampleUserId() {
  const sampleUserId = "4ce6fadd-3e10-40e2-8a6d-f94c9f859078"; // يمكنك تغيير هذا إلى أي معرف تجريبي تريده
  if (!sessionStorage.getItem("userId")) {
    sessionStorage.setItem("userId", sampleUserId);
    console.log("تم تعيين معرف مستخدم تجريبي في sessionStorage:", sampleUserId);
  }
}
/**
   * تعيين معرف مستخدم تجريبي إذا لم يكن موجودًا
...
function setSamplename() {
  ...
  if (!sessionStorage.getItem("name")) {
    ...
    console.log("تم تعيين معرف مستخدم تجريبي في sessionStorage:", samplename);
  }
}
function setSampleusername() {
  ...
  if (!sessionStorage.getItem("username")) {
    ...
    console.log("تم تعيين معرف مستخدم تجريبي في sessionStorage:", sampleusername);
  }
}
function setSampleemail() {
  ...
  if (!sessionStorage.getItem("email")) {
    ...
    console.log("تم تعيين معرف مستخدم تجريبي في sessionStorage:", sampleemail);
  }
}
function setSamplephone_number() {
  ...
  if (!sessionStorage.getItem("phone_number")) {
    ...
    console.log("تم تعيين معرف مستخدم تجريبي في sessionStorage:", samplephone_number);
  }
}
function setSamplesubscriptionStatus() {
  const samplesubscriptionStatus = "ACTIVE"; // يمكنك تغيير هذا إلى أي معرف تجريبي تريده
  if (!sessionStorage.getItem("subscriptionStatus")) {
    sessionStorage.setItem("subscriptionStatus", samplesubscriptionStatus);
    console.log("تم تعيين معرف مستخدم تجريبي في sessionStorage:", samplesubscriptionStatus);
  }
}
  ...
  (function () {
    ...
    async function fetchRegistrationNumber(userId) {
      ...
      try {
        ...
        if (registrationNumber) {
          ...
          console.log("Stored registration number in sessionStorage:", registrationNumber);
    ...
    async function fetchSubscriptionStatus() {
      ...
      try {
        ...
        if (subscriptionStatus) {
          ...
          console.log("Subscription status stored in sessionStorage:", subscriptionStatus);
      ...
      if (authCode) {
        try {
          ...
          if (userInfo.username) {
            ...
            console.log("username stored in sessionStorage:", userInfo.username);
          }
          // Store name, email, phone_number, etc.
          if (userInfo.name) {
            sessionStorage.setItem("name", userInfo.name);
            console.log("Name stored in sessionStorage:", userInfo.name);
            
          }
          
          if (userInfo.email) {
            sessionStorage.setItem("email", userInfo.email);
            console.log("email stored in sessionStorage:", userInfo.email);
          }

          if (userInfo.phone_number) {
            sessionStorage.setItem("phone_number", userInfo.phone_number);
            console.log("phone_number stored in sessionStorage:", userInfo.phone_number);
          }
    ...
    function displayname() {
      ...
      if (name) {
        ...
        if (nameDisplay) {
          ...
          console.log("Name displayed:", name);
        } else {
    ...
    function toggleNotificationPopup(notifications) {
      ...
      if (notificationPopup) {
        ...
        console.log("Displaying notification popup:", notifications);
        ...
        overlay.addEventListener("click", function () {
          ...
          console.log("Notification popup closed by clicking on overlay.");
        });
    ...
    async function handleSubscribeClick() {
        ...
        try {
            ...
            console.log("Generating payment link for userId:", customerProfileId);
    ...
    function loadCognitoSDK(callback) {
      if (typeof AmazonCognitoIdentity === "undefined") {
        ...
        script.onload = function () {
          console.log("Amazon Cognito Identity SDK loaded successfully.");
          callback();
        };
    ...
    function validatePasswordAndDeleteAccount(password) {
      console.log("Validating password and deleting account...");
      ...
      cognitoUser.authenticateUser(authenticationDetails, {
        onSuccess: function (result) {
          console.log("Authentication successful. Deleting account...");
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const nameDisplay = document.getElementById("nameDisplay"); // Greeting element
      ...
      if (sidebar && toggleButton && overlay && nameDisplay) {
        ...
        console.error("One or more elements are missing: sidebar, toggleButton, overlay, or nameDisplay.");
      }
    });
